...
$headerFiles = Get-ChildItem -Path $SourceFolder -Filter *.h -Recurse -File | Where-Object {
    $_.FullName -inotmatch "\\implementation\\" -and $_.FullName -inotmatch "/implementation/" -and $_.FullName -inotmatch "\\DirectXTex\\" -and $_.FullName -inotmatch "/DirectXTex/" -and $_.Name -inotlike "*_inl.h"
}
