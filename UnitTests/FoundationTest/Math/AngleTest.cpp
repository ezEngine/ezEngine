...
EZ_CREATE_SIMPLE_TEST(Math, Angle)
{
  ...
  EZ_TEST_BLOCK(ezTestBlock::Enabled, "NormalizeRange / IsEqual ")
  {
    ...
    {
      a = ezAngle::Degree((float)i);
      a.NormalizeRange();
      EZ_TEST_FLOAT(a.GetDegree(), (float)i, 0.01f);
      a = ezAngle::Degree((float)i);
      a.NormalizeRange();
      EZ_TEST_FLOAT(a.GetDegree(), (float)i, 0.01f);
      a = ezAngle::Degree((float)i + 360.0f);
      a.NormalizeRange();
      EZ_TEST_FLOAT(a.GetDegree(), (float)i, 0.01f);
      a = ezAngle::Degree((float)i - 360.0f);
      a.NormalizeRange();
      EZ_TEST_FLOAT(a.GetDegree(), (float)i, 0.01f);
      a = ezAngle::Degree((float)i + 3600.0f);
      a.NormalizeRange();
      EZ_TEST_FLOAT(a.GetDegree(), (float)i, 0.01f);
      a = ezAngle::Degree((float)i - 3600.0f);
      a.NormalizeRange();
      EZ_TEST_FLOAT(a.GetDegree(), (float)i, 0.01f);
      a = ezAngle::Degree((float)i + 36000.0f);
      a.NormalizeRange();
      EZ_TEST_FLOAT(a.GetDegree(), (float)i, 0.01f);
      a = ezAngle::Degree((float)i - 36000.0f);
      a.NormalizeRange();
    ...
    {
      a = ezAngle::Degree((float)i);
      EZ_TEST_BOOL(a.GetNormalizedRange().IsEqualSimple(ezAngle::Degree((float)i), ezAngle::Degree(0.01f)));
      a = ezAngle::Degree((float)i);
      EZ_TEST_BOOL(a.GetNormalizedRange().IsEqualSimple(ezAngle::Degree((float)i), ezAngle::Degree(0.01f)));
      a = ezAngle::Degree((float)i + 360.0f);
      EZ_TEST_BOOL(a.GetNormalizedRange().IsEqualSimple(ezAngle::Degree((float)i), ezAngle::Degree(0.01f)));
    ...
    {
      a = ezAngle::Degree((float)i);
      EZ_TEST_BOOL(a.IsEqualNormalized(ezAngle::Degree((float)i), ezAngle::Degree(0.01f)));
      a = ezAngle::Degree((float)i);
      EZ_TEST_BOOL(a.IsEqualNormalized(ezAngle::Degree((float)i), ezAngle::Degree(0.01f)));
      a = ezAngle::Degree((float)i + 360.0f);
      EZ_TEST_BOOL(a.IsEqualNormalized(ezAngle::Degree((float)i), ezAngle::Degree(0.01f)));
