...
EZ_CREATE_SIMPLE_TEST(Image, Image)
{
  ...
  EZ_TEST_BLOCK(ezTestBlock::Enabled, "BMP - Good")
  {
    const char* testImagesGood[] = {
        ...
        /*"BMPTestImages/good/pal8topdown",*/ "BMPTestImages/good/pal8v4",
        ...
        "BMPTestImages/good/rgb32", /*"BMPTestImages/good/rgb32bf"*/
    };
  ...
  EZ_TEST_BLOCK(ezTestBlock::Enabled, "BMP - Bad")
  {
    const char* testImagesBad[] = {
        ...
        /*"BMPTestImages/bad/badplanes",*/ "BMPTestImages/bad/badrle",
        "BMPTestImages/bad/badwidth",
        /*"BMPTestImages/bad/pal2",*/ "BMPTestImages/bad/pal8badindex",
        "BMPTestImages/bad/reallybig",
        "BMPTestImages/bad/rletopdown",
    ...
    for (int i = 0; i < EZ_ARRAY_SIZE(testImagesBad); i++)
    {
      ezImage image;
      {
        ...
        EZ_TEST_BOOL_MSG(image.LoadFrom(fileName.GetData(), &LogIgnore) == EZ_FAILURE, "Reading image should have failed: '%s'",
                         fileName.GetData());
      }
    }
  }
  ...
  {
    const char* testImagesGood[] = {"TGATestImages/good/RGB", "TGATestImages/good/RGBA", "TGATestImages/good/RGB_RLE",
