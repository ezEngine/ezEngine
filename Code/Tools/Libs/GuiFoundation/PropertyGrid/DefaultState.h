...
/// Registry for all ezDefaultStateProvider factory functions.
class EZ_GUIFOUNDATION_DLL ezDefaultState
{
public:
  /// The functor interface for the ezDefaultStateProvider factory function
  ///
  ...
  /// Registers a ezDefaultStateProvider factory method. It is safe to register / unregister factories at any time.
  static void RegisterDefaultStateProvider(CreateStateProviderFunc func);
  /// Unregisters a ezDefaultStateProvider factory method.
...
public:
  /// Constructor. Will collect the appropriate ezDefaultStateProviders to query the states.
  ...
  /// Returns the color of the top-most ezDefaultStateProvider of the first element of the selection.
  ezColorGammaUB GetBackgroundColor() const;
  /// Returns the name of the top-most ezDefaultStateProvider of the first element of the selection.
