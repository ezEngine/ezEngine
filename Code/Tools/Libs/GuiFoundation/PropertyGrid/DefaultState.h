...
public:
  ...
  typedef ezSharedPtr<ezDefaultStateProvider> (*CreateStateProviderFunc)(ezObjectAccessorBase* pAccessor, const ezDocumentObject* pObject, const ezAbstractProperty* pProp);
