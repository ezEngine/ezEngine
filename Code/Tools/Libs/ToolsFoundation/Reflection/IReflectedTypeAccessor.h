...
/// Provides access to the properties of an ezRTTI compatible data storage.
class EZ_TOOLSFOUNDATION_DLL ezIReflectedTypeAccessor
{
public:
  /// Constructor for the ezIReflectedTypeAccessor.
  ///
  ...
  /// Returns the ezRTTI* of the wrapped instance type.
