...
ezSaveDocumentTask::ezSaveDocumentTask(ezTask::OnTaskFinished onTaskFinished)
{
...
ezAfterSaveDocumentTask::ezAfterSaveDocumentTask(ezTask::OnTaskFinished onTaskFinished)
{
