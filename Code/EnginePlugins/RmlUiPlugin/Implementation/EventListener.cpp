...
namespace ezRmlUiInternal
{
  ...
  void EventListener::OnDetach(Rml::Core::Element* element)
  {
  ...
  void EventListenerInstancer::ReturnToPool(EventListener& listener)
  {
    m_EventListenerFreelist.PushBack(listener.m_uiIndex);
  }
