...
public:
  ...
  /// \brief Sets the half-extents of the search box used to snap an arbitrary position onto the nearest navmesh
  ...
  /// \brief Finds the closest point on the navmesh to vPos, e.g. to clamp a position back onto walkable ground.
  ///
