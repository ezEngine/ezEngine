...
using ezATLEntitiesLookup = ezATLMapLookup<class ezATLEntity>;
using ezATLTriggersLookup = ezATLMapLookup<class ezATLTrigger>;
using ezATLEventsLookup = ezATLMapLookup<class ezATLEvent>;
