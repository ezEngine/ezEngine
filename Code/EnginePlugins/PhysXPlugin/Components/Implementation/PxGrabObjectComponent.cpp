...
void ezPxGrabObjectComponent::SerializeComponent(ezWorldWriter& inout_stream) const
{
...
void ezPxGrabObjectComponent::DeserializeComponent(ezWorldReader& inout_stream)
{
