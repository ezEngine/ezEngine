...
void ezPxSphericalJointComponent::SerializeComponent(ezWorldWriter& inout_stream) const
{
...
void ezPxSphericalJointComponent::DeserializeComponent(ezWorldReader& inout_stream)
{
