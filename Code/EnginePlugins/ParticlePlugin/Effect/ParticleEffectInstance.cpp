...
ezSimdVec4f ezParticleEffectInstance::GetWindAt(const ezSimdVec4f& position) const
{
  ...
  const ezUInt32 x0 = pos0.x();
  const ezUInt32 y0 = y0z0y1z1.x();
  const ezUInt32 z0 = y0z0y1z1.y();

  const ezUInt32 x1 = pos1.x();
  const ezUInt32 y1 = y0z0y1z1.z();
  const ezUInt32 z1 = y0z0y1z1.w();
  ...
  const ezSimdVec4f sample_z0y0x0 = pSamples[z0 + y0 + x0];
  const ezSimdVec4f sample_z0y0x1 = pSamples[z0 + y0 + x1];
  const ezSimdVec4f res_z0y0 = ezSimdVec4f::Lerp(sample_z0y0x0, sample_z0y0x1, wX);

  const ezSimdVec4f sample_z0y1x0 = pSamples[z0 + y1 + x0];
  const ezSimdVec4f sample_z0y1x1 = pSamples[z0 + y1 + x1];
  ...
  const ezSimdVec4f sample_z1y0x0 = pSamples[z1 + y0 + x0];
  const ezSimdVec4f sample_z1y0x1 = pSamples[z1 + y0 + x1];
  const ezSimdVec4f res_z1y0 = ezSimdVec4f::Lerp(sample_z1y0x0, sample_z1y0x1, wX);

  const ezSimdVec4f sample_z1y1x0 = pSamples[z1 + y1 + x0];
  const ezSimdVec4f sample_z1y1x1 = pSamples[z1 + y1 + x1];
