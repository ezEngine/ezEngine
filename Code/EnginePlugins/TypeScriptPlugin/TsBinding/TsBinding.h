...
private:
  ...
  static void InjectEnumImportExport(const char* szFile, const char* szEnumFile);
  static void InjectFlagsImportExport(const char* szFile, const char* szEnumFile);

  static void RemoveAutoGeneratedCode(const char* szFile);
  static void AppendToTextFile(const char* szFile, ezStringView text);
