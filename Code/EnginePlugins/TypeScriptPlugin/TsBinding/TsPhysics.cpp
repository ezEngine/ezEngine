...
static int __CPP_Physics_SweepTestSphere(duk_context* pDuk)
{
  ...
  ezPhysicsCastResult res;
  if (!pModule->SweepTestSphere(res, fRadius, vStart, vDir, fDistance, ezPhysicsQueryParameters(uiCollisionLayer, ezPhysicsShapeType::Default, uiIgnoreShapeID)))
  {
    return duk.ReturnNull();
  }
...
static int __CPP_Physics_SweepTestBox(duk_context* pDuk)
{
  ...
  ezPhysicsCastResult res;
  if (!pModule->SweepTestBox(res, vExtents, transform, vDir, fDistance, ezPhysicsQueryParameters(uiCollisionLayer, ezPhysicsShapeType::Default, uiIgnoreShapeID)))
  {
    return duk.ReturnNull();
  }
...
static int __CPP_Physics_SweepTestCapsule(duk_context* pDuk)
{
  ...
  ezPhysicsCastResult res;
  if (!pModule->SweepTestCapsule(res, fCapsuleRadius, fCapsuleHeight, transform, vDir, fDistance, ezPhysicsQueryParameters(uiCollisionLayer, ezPhysicsShapeType::Default, uiIgnoreShapeID)))
  {
    return duk.ReturnNull();
  }
...
static int __CPP_Physics_OverlapTestSphere(duk_context* pDuk)
{
  ...
  return duk.ReturnBool(pModule->OverlapTestSphere(fRadius, vPos, ezPhysicsQueryParameters(uiCollisionLayer, ezPhysicsShapeType::Default, uiIgnoreShapeID)));
}
...
static int __CPP_Physics_OverlapTestCapsule(duk_context* pDuk)
{
  ...
  return duk.ReturnBool(pModule->OverlapTestCapsule(fCapsuleRadius, fCapsuleHeight, transform, ezPhysicsQueryParameters(uiCollisionLayer, ezPhysicsShapeType::Default, uiIgnoreShapeID)));
}
