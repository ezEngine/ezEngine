...
EZ_STATICLINK_LIBRARY(JoltPlugin)
{
  ...
  EZ_STATICLINK_REFERENCE(JoltPlugin_Actors_Implementation_JoltHeightfieldColliderComponent);
  ...
  EZ_STATICLINK_REFERENCE(JoltPlugin_Components_Implementation_JoltGenerateCollisionComponent);
  ...
  EZ_STATICLINK_REFERENCE(JoltPlugin_Components_Implementation_JoltWaterVolumeComponent);
  ...
  EZ_STATICLINK_REFERENCE(JoltPlugin_Resources_JoltHeightfieldResource);
