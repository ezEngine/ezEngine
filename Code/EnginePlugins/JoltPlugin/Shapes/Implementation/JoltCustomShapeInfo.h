...
public:
  ...
  void CollideSoftBodyVertices(JPH::Mat44Arg inCenterOfMassTransform, JPH::Vec3Arg inScale, JPH::SoftBodyVertex* pVertices, JPH::uint inNumVertices, float fDeltaTime, JPH::Vec3Arg inDisplacementDueToGravity, int inCollidingShapeIndex) const override;
