...
enum class ReactionPrefabVersion
{
  Version_0 = 0,
  Version_1,
  //Version_2, // added Prefab parameters
...
void ezParticleEventReaction_Prefab::ProcessEvent(const ezParticleEvent& e)
{
  ...
  // TODO: modes how to align the spawned Prefab (direction, normal, reflected dir, etc.)
  trans.m_qRotation.SetShortestRotation(ezVec3(1, 0, 0), e.m_vNormal); 
