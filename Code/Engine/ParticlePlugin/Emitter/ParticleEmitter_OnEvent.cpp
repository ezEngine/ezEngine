...
void ezParticleEmitterFactory_OnEvent::Load(ezStreamReader& stream)
{
  ...
  EZ_ASSERT_DEV(uiVersion <= (int)EmitterOnEventVersion::Version_Current, "Invalid version %u", uiVersion);
...
void ezParticleEmitter_OnEvent::SpawnElements(ezUInt64 uiStartIndex, ezUInt64 uiNumElements)
{
