...
public:
  ...
  ezParticleEffectInstance* CreateParticleEffectInstance(const ezParticleEffectResourceHandle& hResource);
  ...
  void DestroyParticleEffectInstance(ezParticleEffectInstance* pInstance);
