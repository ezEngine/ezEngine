...
public:
  ...
  /// Returns true, if the given string is a NULL pointer or a string that immediately terminates with a '\0' character.
  template <typename T>
  ...
  /// Searches for the first occurrence of szStringToFind in szSource after uiFirstCharacter. 
  ...
  /// Searches for the first occurrence of szStringToFind in szSource after uiFirstCharacter. Ignores case.
  ...
  /// Searches for the last occurrence of szStringToFind in szSource before uiFirstCharacter.
  ...
  /// Searches for the last occurrence of szStringToFind in szSource before uiFirstCharacter. Ignores case.
  ...
  /// Function Definition for a function that determines whether a (Utf32) character delimits a word, when it is at the front or back of it.
