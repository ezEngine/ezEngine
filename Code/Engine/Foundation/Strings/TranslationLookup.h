...
public:
  ...
  /// Prefer to use the ezTranslate macro instead of calling this function directly. Will query all translators for a translation,
  /// until one is found.
...
/// Use this macro to query a translation for a string from the ezTranslationLookup system
...
/// Use this macro to query a translation for a tooltip string from the ezTranslationLookup system
...
/// Use this macro to query a translation for a help URL from the ezTranslationLookup system
