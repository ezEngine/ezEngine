...
struct ezSimdRandom
{
  ...
  static ezSimdVec4u UInt(const ezSimdVec4i& vPosition, const ezSimdVec4u& vSeed = ezSimdVec4u::MakeZero());

  /// \brief Returns 4 random float values in range [0.0 ; 1.0], ie. including zero and one
  static ezSimdVec4f FloatZeroToOne(const ezSimdVec4i& vPosition, const ezSimdVec4u& vSeed = ezSimdVec4u::MakeZero());

  /// \brief Returns 4 random float values in range [fMinValue ; fMaxValue]
  static ezSimdVec4f FloatMinMax(const ezSimdVec4i& vPosition, const ezSimdVec4f& vMinValue, const ezSimdVec4f& vMaxValue, const ezSimdVec4u& vSeed = ezSimdVec4u::MakeZero());
};
