...
public:
  ...
  EZ_ALWAYS_INLINE const_iterator_base& operator++() { m_iIndex += 1; return *this; }
  EZ_ALWAYS_INLINE const_iterator_base& operator--() { m_iIndex -= 1; return *this; }

  EZ_ALWAYS_INLINE const_iterator_base operator++(int) { m_iIndex += 1; return const_iterator_base(*m_Array, m_iIndex - 1); }
  EZ_ALWAYS_INLINE const_iterator_base operator--(int) { m_iIndex -= 1; return const_iterator_base(*m_Array, m_iIndex + 1); }
  ...
  inline const T& operator*() const { if (reverse) return (*m_Array)[m_Array->GetCount() - (ezUInt32)m_iIndex - 1]; else return (*m_Array)[(ezUInt32)m_iIndex]; }
...
public:
  ...
  EZ_ALWAYS_INLINE iterator_base& operator++() { this->m_iIndex += 1; return *this; }
  EZ_ALWAYS_INLINE iterator_base& operator--() { this->m_iIndex -= 1; return *this; }

  EZ_ALWAYS_INLINE iterator_base operator++(int) { this->m_iIndex += 1; return iterator_base(*this->m_Array, this->m_iIndex - 1); }
  EZ_ALWAYS_INLINE iterator_base operator--(int) { this->m_iIndex -= 1; return iterator_base(*this->m_Array, this->m_iIndex + 1); }
  ...
  using const_iterator_base<ARRAY, T, reverse>::operator*;
  inline T& operator*() { if (reverse) return (*this->m_Array)[this->m_Array->GetCount() - (ezUInt32) this->m_iIndex - 1]; else return (*this->m_Array)[(ezUInt32) this->m_iIndex]; }
  using const_iterator_base<ARRAY, T, reverse>::operator->;
...
public:
  ...
  EZ_ALWAYS_INLINE const_reverse_pointer_iterator& operator++() { m_ptr--; return *this; }
  EZ_ALWAYS_INLINE const_reverse_pointer_iterator& operator--() { m_ptr++; return *this; }

  EZ_ALWAYS_INLINE const_reverse_pointer_iterator operator++(int) { m_ptr--; return const_reverse_pointer_iterator(m_ptr + 1); }
  EZ_ALWAYS_INLINE const_reverse_pointer_iterator operator--(int) { m_ptr++; return const_reverse_pointer_iterator(m_ptr - 1); }
...
public:
  ...
  EZ_ALWAYS_INLINE reverse_pointer_iterator& operator++() { this->m_ptr--; return *this; }
  EZ_ALWAYS_INLINE reverse_pointer_iterator& operator--() { this->m_ptr++; return *this; }

  EZ_ALWAYS_INLINE reverse_pointer_iterator operator++(int) { this->m_ptr--; return reverse_pointer_iterator(this->m_ptr + 1); }
  EZ_ALWAYS_INLINE reverse_pointer_iterator operator--(int) { this->m_ptr++; return reverse_pointer_iterator(this->m_ptr - 1); }
