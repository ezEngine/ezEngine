...
{
  /// Converts the data that \a pElement points to to an ezColor.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezColorGammaUB.
  ///
  /// \a pElement may be a primitives list of 3 or 4 floats or of 3 or 4 unsigned int8 values.
  /// It may also be a group that contains such a primitives list as the only child.
  /// floats will be interpreted as linear colors, unsigned int 8 will be interpreted as ezColorGammaUB.
  ...
  /// Converts the data that \a pElement points to to an ezTime.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec2.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec3.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec4.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec2I32.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec3I32.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec4I32.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec2U32.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec3U32.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezVec4U32.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezMat3.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezMat4.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezTransform.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezQuat.
  ///
  /// \a pElement maybe be a primitives list of exactly 4 floats.
  /// It may also be a group that contains such a primitives list as the only child.
  EZ_FOUNDATION_DLL ezResult ConvertToQuat(const ezOpenDdlReaderElement* pElement, ezQuat& out_qResult); // [tested]

  /// Converts the data that \a pElement points to to an ezUuid.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezAngle.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezHashedString.
  ///
  ...
  /// Converts the data that \a pElement points to to an ezTempHashedString.
  ///
  ...
  /// Uses the elements custom type name to infer which type the object holds and reads it into the ezVariant.
  ///
  ...
  /// Writes an ezColor to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezColorGammaUB to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezTime to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezVec2 to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezVec3 to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezVec4 to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezMat3 to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezMat4 to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezTransform to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezQuat to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezUuid to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezAngle to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezHashedString to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezTempHashedString to DDL such that the type can be reconstructed.
  ...
  /// Writes an ezVariant to DDL such that the type can be reconstructed.
