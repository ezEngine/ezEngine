...
template <typename ValueType, typename IteratorType>
EZ_FORCE_INLINE bool ezRangeView<ValueType, IteratorType>::ConstIterator::
operator==(const typename ezRangeView<ValueType, IteratorType>::ConstIterator& it2) const
{
...
template <typename ValueType, typename IteratorType>
EZ_FORCE_INLINE ezRangeView<ValueType, IteratorType>::ConstIterator::ConstIterator(const ezRangeView<ValueType, IteratorType>* view,
                                                                                   IteratorType pos)
{
  m_View = view;
  m_Pos = pos;
