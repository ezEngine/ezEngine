...
class EZ_FOUNDATION_DLL ezImageFilter
{
public:
...
/// \brief Box filter
class EZ_FOUNDATION_DLL ezImageFilterBox : public ezImageFilter
{
public:
...
class EZ_FOUNDATION_DLL ezImageFilterTriangle : public ezImageFilter
{
public:
...
struct EZ_FOUNDATION_DLL ezImageAddressMode
{
  enum Enum
  {
    WRAP = 0,
...
#include <Foundation/Image/Implementation/ImageFilter_inl.h>
