...
inline ezColor ezColor::MakeFromKelvin(ezUInt32 uiKelvin)
{
  ...
  finalColor.g = kelvin < 6.570f ?
    ezMath::Saturate((-399.809f + 414.271f * kelvin + 111.543f * kelvin2) / (2779.24f + 164.143f * kelvin + 84.7356f * kelvin2)) :
    ezMath::Saturate((1370.38f + 734.616f * kelvin + 0.689955f * kelvin2) / (-4625.69f + 1699.87f * kelvin));
