...
namespace ezMath
{
  ...
  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> SinDeg(ezFixedPoint<DecimalBits> f)
  {
    //EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) sin(DegToRad(f.ToDouble()));
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> CosDeg(ezFixedPoint<DecimalBits> f)
  {
    //EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) cos(DegToRad(f.ToDouble()));
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> SinRad(ezFixedPoint<DecimalBits> f)
  {
    //EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) sin(f.ToDouble());
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> CosRad(ezFixedPoint<DecimalBits> f)
  {
    //EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) cos(f.ToDouble());
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> TanDeg(ezFixedPoint<DecimalBits> f)
  {
    EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) tan(DegToRad(f.ToDouble()));
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> TanRad(ezFixedPoint<DecimalBits> f)
  {
    EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) tan(f.ToDouble());
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> ASinDeg(ezFixedPoint<DecimalBits> f)
  {
    EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) RadToDeg(asin(f.ToDouble()));
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> ACosDeg(ezFixedPoint<DecimalBits> f)
  {
    //EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) RadToDeg(acos(f.ToDouble()));
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> ASinRad(ezFixedPoint<DecimalBits> f)
  {
    EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) asin(f.ToDouble());
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> ACosRad(ezFixedPoint<DecimalBits> f)
  {
    //EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) acos(f.ToDouble());
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> ATanDeg(ezFixedPoint<DecimalBits> f)
  {
    EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) RadToDeg(atan(f.ToDouble()));
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> ATanRad(ezFixedPoint<DecimalBits> f)
  {
    EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) atan(f.ToDouble());
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> ATan2Deg(ezFixedPoint<DecimalBits> x, ezFixedPoint<DecimalBits> y)
  {
    EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) RadToDeg(atan2(x.ToDouble(), y.ToDouble()));
  }

  template<ezUInt8 DecimalBits>
  EZ_FORCE_INLINE ezFixedPoint<DecimalBits> ATan2Rad(ezFixedPoint<DecimalBits> x, ezFixedPoint<DecimalBits> y)
  {
    EZ_REPORT_FAILURE("This function is not really implemented yet.");

    return (ezFixedPoint<DecimalBits>) atan2(x.ToDouble(), y.ToDouble());
  }
