...
namespace ezIntersectionUtils
{
  ...
  EZ_FOUNDATION_DLL bool RayPolygonIntersection(const ezVec3& vRayStartPos, const ezVec3& vRayDir, const ezVec3* pPolygonVertices, ezUInt32 uiNumVertices, float* out_fIntersectionTime = NULL, ezVec3* out_vIntersectionPoint = NULL, ezUInt32 uiVertexStride = sizeof(ezVec3)); // [tested]
