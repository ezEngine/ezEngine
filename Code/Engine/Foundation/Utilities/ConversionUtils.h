...
namespace ezConversionUtils
{
  ...
  EZ_FOUNDATION_DLL ezResult StringToInt(ezStringView sText, ezInt32& out_Res, const char** out_LastParsePosition = nullptr); // [tested]
  ...
  EZ_FOUNDATION_DLL ezResult StringToUInt(ezStringView sText, ezUInt32& out_Res, const char** out_LastParsePosition = nullptr); // [tested]

  /// \brief Same as StringToInt but converts to a 64bit integer value instead.
  EZ_FOUNDATION_DLL ezResult StringToInt64(ezStringView sText, ezInt64& out_Res,
  ...
  EZ_FOUNDATION_DLL ezResult StringToFloat(ezStringView sText, double& out_Res, const char** out_LastParsePosition = nullptr); // [tested]
  ...
  ///   EZ_FAILURE otherwise.
  EZ_FOUNDATION_DLL ezResult StringToBool(ezStringView sText, bool& out_Res, const char** out_LastParsePosition = nullptr); // [tested]
  ...
  /// If the ezStringView is shorter than uiMaxHexCharacters, this is interpreted as a valid HEX value with a smaller value.
  ...
  EZ_FOUNDATION_DLL ezResult ConvertHexStringToUInt(ezStringView sHex, ezUInt64& out_uiResult, ezUInt32 uiMaxHexCharacters, ezUInt32* outTotalCharactersParsed); // [tested]
  ...
  EZ_FOUNDATION_DLL ezColor GetColorByName(ezStringView sText, bool* out_ValidColorName = nullptr); // [tested]
