...
protected:
  ...
  virtual void DrawPlatform(ezUInt32 uiVertexCount) override;
  ...
  virtual void DrawInstancedPlatform(ezUInt32 uiVertexCountPerInstance, ezUInt32 uiInstanceCount) override;
