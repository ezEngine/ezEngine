...
ezResult ezGALShaderDX11::InitPlatform(ezGALDevice* pDevice)
{
  ...
  if(m_Description.HasByteCodeForStage(ezGALShaderStage::VertexShader))
  {
    ...
    {
      ezLog::ErrorPrintf("Couldn't create native vertex shader from bytecode!");
      return EZ_FAILURE;
    }
  }
  ...
  if(m_Description.HasByteCodeForStage(ezGALShaderStage::HullShader))
  {
    ...
    {
      ezLog::ErrorPrintf("Couldn't create native hull shader from bytecode!");
      return EZ_FAILURE;
    }
  }
  ...
  if(m_Description.HasByteCodeForStage(ezGALShaderStage::DomainShader))
  {
    ...
    {
      ezLog::ErrorPrintf("Couldn't create native domain shader from bytecode!");
      return EZ_FAILURE;
    }
  }
  ...
  if(m_Description.HasByteCodeForStage(ezGALShaderStage::GeometryShader))
  {
    ...
    {
      ezLog::ErrorPrintf("Couldn't create native geometry shader from bytecode!");
      return EZ_FAILURE;
    }
  }
  ...
  if(m_Description.HasByteCodeForStage(ezGALShaderStage::PixelShader))
  {
    ...
    {
      ezLog::ErrorPrintf("Couldn't create native pixel shader from bytecode!");
      return EZ_FAILURE;
    }
  }
  ...
  if(m_Description.HasByteCodeForStage(ezGALShaderStage::ComputeShader))
  {
    ...
    {
      ezLog::ErrorPrintf("Couldn't create native compute shader from bytecode!");
      return EZ_FAILURE;
    }
  }
