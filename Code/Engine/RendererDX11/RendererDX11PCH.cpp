...
EZ_STATICLINK_LIBRARY(RendererDX11)
{
  ...
  EZ_STATICLINK_REFERENCE(RendererDX11_Resources_Implementation_FenceDX11);
  EZ_STATICLINK_REFERENCE(RendererDX11_Resources_Implementation_QueryDX11);
  ...
  EZ_STATICLINK_REFERENCE(RendererDX11_Resources_Implementation_SharedTextureDX11);
  EZ_STATICLINK_REFERENCE(RendererDX11_Resources_Implementation_UnorderedAccessViewDX11);
