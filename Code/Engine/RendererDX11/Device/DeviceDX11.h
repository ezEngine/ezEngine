...
protected:
  ...
  virtual void BeginPipelinePlatform(const char* szName, ezGALSwapChainHandle hSwapChain) override;
  virtual void EndPipelinePlatform(ezGALSwapChainHandle hSwapChain) override;
