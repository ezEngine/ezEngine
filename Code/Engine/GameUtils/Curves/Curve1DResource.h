...
struct EZ_GAMEUTILS_DLL ezCurve1DResourceDescriptor
{
...
class EZ_GAMEUTILS_DLL ezCurve1DResource : public ezResource<ezCurve1DResource, ezCurve1DResourceDescriptor>
{
