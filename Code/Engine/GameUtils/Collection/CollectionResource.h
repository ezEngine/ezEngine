...
struct EZ_GAMEUTILS_DLL ezCollectionEntry
{
...
struct EZ_GAMEUTILS_DLL ezCollectionResourceDescriptor
{
...
class EZ_GAMEUTILS_DLL ezCollectionResource : public ezResource<ezCollectionResource, ezCollectionResourceDescriptor>
{
