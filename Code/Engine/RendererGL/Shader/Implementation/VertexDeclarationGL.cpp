...
ezResult ezGALVertexDeclarationGL::InitPlatform(ezGALDevice* pDevice)
{
 ...
 // EZ_ASSERT(m_Description.m_VertexAttributes.GetCount() <= GL_MAX_VERTEX_ATTRIBUTES, "Too many vertex attributes! Only %i supported, %i were requested.", GL_MAX_VERTEX_ATTRIBUTES, m_Description.m_VertexAttributes.GetCount());
