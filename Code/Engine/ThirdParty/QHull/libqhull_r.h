...
QHULL_API void    qh_qhull(qhT *qh);
...
QHULL_API int     qh_new_qhull(qhT *qh, int dim, int numpoints, coordT *points, boolT ismalloc,
...
QHULL_API void    qh_init_A(qhT *qh, FILE *infile, FILE *outfile, FILE *errfile, int argc, char *argv[]);
QHULL_API void    qh_init_B(qhT *qh, coordT *points, int numpoints, int dim, boolT ismalloc);
...
QHULL_API void    qh_initflags(qhT *qh, char *command);
...
QHULL_API void    qh_produce_output(qhT *qh);
...
QHULL_API void    qh_check_output(qhT *qh);
