...
/// Description of a shared texture swap chain. Use ezGALSharedTextureSwapChain::Create to create instance.
...
public:
  ...
  /// Creates an instance of a ezGALSharedTextureSwapChain.
