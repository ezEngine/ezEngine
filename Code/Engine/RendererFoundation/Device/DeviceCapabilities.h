...
struct EZ_RENDERERFOUNDATION_DLL ezGALDeviceCapabilities
{
  ...
  bool m_bSupportsMultipleSRVTypes = true; ///< Whether more than of of ezGALBufferUsageFlags::StructuredBuffer, ezGALBufferUsageFlags::TexelBuffer and ezGALBufferUsageFlags::ByteAddressBuffer is supported on a buffer.
