...
struct EZ_RENDERERFOUNDATION_DLL ezGALDeviceCapabilities
{
  ...
  bool m_bSupportsDepthBiasClamp = false;  ///< Whether ezGALRasterizerStateCreationDescription::m_fDepthBiasClamp is honored. If false, the value is silently treated as 0.
