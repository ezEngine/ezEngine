...
void ezGreyBoxComponent::BuildGeometry(ezGeometry& geom, ezEnum<ezGreyBoxShape> shape, bool bOnlyRoughDetails) const
{
  ...
  switch (shape)
  {
    ...
    case ezGreyBoxShape::RampY:
      ...
      opt.m_Transform.SetRotationMatrixZ(ezAngle::MakeFromDegree(-90.0f));
    ...
    case ezGreyBoxShape::ArchX:
    {
      ...
      t2.SetRotationMatrixX(ezAngle::MakeFromDegree(90));
    ...
    case ezGreyBoxShape::ArchY:
    {
      opt.m_Transform.SetRotationMatrixY(ezAngle::MakeFromDegree(-90));
      t2.SetRotationMatrixX(ezAngle::MakeFromDegree(90));
      t3.SetRotationMatrixZ(ezAngle::MakeFromDegree(90));
