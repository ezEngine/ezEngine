...
EZ_STATICLINK_LIBRARY(GameEngine)
{
  ...
  EZ_STATICLINK_REFERENCE(GameEngine_VisualScript_Implementation_VisualScriptInstanceAssignFunctions);
  ...
  EZ_STATICLINK_REFERENCE(GameEngine_VisualScript_Nodes_VisualScriptBasicNodes);
  ...
  EZ_STATICLINK_REFERENCE(GameEngine_VisualScript_Nodes_VisualScriptStringNodes);
  EZ_STATICLINK_REFERENCE(GameEngine_VisualScript_Nodes_VisualScriptVariableNodes);
  EZ_STATICLINK_REFERENCE(GameEngine_VisualScript_Nodes_VisualScriptVariantNodes);
