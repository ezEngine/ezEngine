...
EZ_STATICLINK_LIBRARY(GameEngine)
{
  ...
  EZ_STATICLINK_REFERENCE(GameEngine_Animation_Implementation_FollowPathComponent);
  EZ_STATICLINK_REFERENCE(GameEngine_Animation_Implementation_PathComponent);
  ...
  EZ_STATICLINK_REFERENCE(GameEngine_Physics_Implementation_ClothSheetSimulator);
  EZ_STATICLINK_REFERENCE(GameEngine_Physics_Implementation_CollisionFilter);
  EZ_STATICLINK_REFERENCE(GameEngine_Physics_Implementation_RopeSimulator);
  ...
  EZ_STATICLINK_REFERENCE(GameEngine_StateMachine_Implementation_StateMachineInstanceData);
  ...
  EZ_STATICLINK_REFERENCE(GameEngine_Utils_Implementation_SceneLoadUtil);
  EZ_STATICLINK_REFERENCE(GameEngine_Volumes_Implementation_VolumeComponent);
  EZ_STATICLINK_REFERENCE(GameEngine_Volumes_Implementation_VolumeSampler);
  ...
  EZ_STATICLINK_REFERENCE(GameEngine_XR_Implementation_DummyXR);
