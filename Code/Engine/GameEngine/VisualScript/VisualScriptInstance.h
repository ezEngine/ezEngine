...
public:
  ...
  /// ExecuteScript() call.
  bool HandleMessage(ezMessage& ref_msg);
...
private:
  ...
  const ezAbstractFunctionProperty* SearchForScriptableFunctionOnType(const ezRTTI* pObjectType, ezStringView sFuncName, const ezScriptableFunctionAttribute*& out_pSfAttr) const;
