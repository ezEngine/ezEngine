...
#include <GameEngine/Animation/MaterialAnimComponent.h>
...
void ezMaterialAnimComponent::Update()
{
  ...
  ezResourceLock<ezPropertyAnimResource> pAnim(m_hPropertyAnim, ezResourceAcquireMode::AllowLoadingFallback);
