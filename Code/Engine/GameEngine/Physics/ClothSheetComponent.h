...
class EZ_GAMEENGINE_DLL ezClothSheetComponentManager : public ezComponentManager<class ezClothSheetComponent, ezBlockStorageType::FreeList>
{
public:
...
class EZ_GAMEENGINE_DLL ezClothSheetRenderData final : public ezRenderData
{
...
class EZ_GAMEENGINE_DLL ezClothSheetRenderer : public ezRenderer
{
...
struct EZ_GAMEENGINE_DLL ezClothSheetFlags
{
...
EZ_DECLARE_REFLECTABLE_TYPE(EZ_GAMEENGINE_DLL, ezClothSheetFlags);

class EZ_GAMEENGINE_DLL ezClothSheetComponent : public ezRenderComponent
{
