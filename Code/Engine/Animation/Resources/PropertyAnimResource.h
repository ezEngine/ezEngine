...
struct EZ_ANIMATION_DLL ezPropertyAnimTarget
{
...
EZ_DECLARE_REFLECTABLE_TYPE(EZ_ANIMATION_DLL, ezPropertyAnimTarget);


struct EZ_ANIMATION_DLL ezPropertyAnimMode
{
  typedef ezUInt8 StorageType;
...
EZ_DECLARE_REFLECTABLE_TYPE(EZ_ANIMATION_DLL, ezPropertyAnimMode);


struct EZ_ANIMATION_DLL ezPropertyAnimEntry
{
...
EZ_DECLARE_REFLECTABLE_TYPE(EZ_ANIMATION_DLL, ezPropertyAnimEntry);
...
struct EZ_ANIMATION_DLL ezPropertyAnimResourceDescriptor : public ezRefCounted
{
...
EZ_DECLARE_REFLECTABLE_TYPE(EZ_ANIMATION_DLL, ezPropertyAnimResourceDescriptor);



typedef ezTypedResourceHandle<class ezPropertyAnimResource> ezPropertyAnimResourceHandle;

class EZ_ANIMATION_DLL ezPropertyAnimResource : public ezResource<ezPropertyAnimResource, ezPropertyAnimResourceDescriptor>
{
