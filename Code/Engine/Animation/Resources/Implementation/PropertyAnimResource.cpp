...
EZ_BEGIN_STATIC_REFLECTED_TYPE(ezPropertyAnimEntry, ezNoBase, 1, ezRTTIDefaultAllocator<ezPropertyAnimEntry>)
{
  EZ_BEGIN_PROPERTIES
  {
    ...
    EZ_ACCESSOR_PROPERTY("Number Curve", ezPropertyAnimEntry::GetNumberCurveFile, ezPropertyAnimEntry::SetNumberCurveFile)->AddAttributes(new ezAssetBrowserAttribute("Curve1D")),
    EZ_ACCESSOR_PROPERTY("Color Gradient", ezPropertyAnimEntry::GetColorCurveFile, ezPropertyAnimEntry::SetColorCurveFile)->AddAttributes(new ezAssetBrowserAttribute("ColorGradient")),
  }
  EZ_END_PROPERTIES
}
