...
const char* ezInputManager::ConvertScanCodeToEngineName(ezUInt8 uiScanCode, bool bIsExtendedKey)
{
  ...
  switch (uiFinalScanCode)
  {
    ...
    case 128 + 16:
      return ezInputSlot_KeyPrevTrack;
    case 128 + 25:
      return ezInputSlot_KeyNextTrack;
    case 128 + 28:
      return ezInputSlot_KeyNumpadEnter;
    case 128 + 29:
      return ezInputSlot_KeyRightCtrl;
    case 128 + 32:
      return ezInputSlot_KeyMute;
    case 128 + 34:
      return ezInputSlot_KeyPlayPause;
    case 128 + 36:
      return ezInputSlot_KeyStop;
    case 128 + 46:
      return ezInputSlot_KeyVolumeDown;
    case 128 + 48:
      return ezInputSlot_KeyVolumeUp;
    case 128 + 53:
