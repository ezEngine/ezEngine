...
namespace ezCollectionUtils
{
  ...
  EZ_CORE_DLL void AddFiles(ezCollectionResourceDescriptor& collection, ezStringView sAssetTypeName, ezStringView sAbsPathToFolder,
  ...
  EZ_CORE_DLL void AddResourceHandle(ezCollectionResourceDescriptor& collection, ezTypelessResourceHandle handle, ezStringView sAssetTypeName, ezStringView sAbsFolderpath);
