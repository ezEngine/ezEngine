...
/// An ezLogInterface that expects and handles error messages during test runs. Can be
...
public:
  ...
  void ExpectMessage(const char* szMsg, ezLogMsgType::Enum type = ezLogMsgType::All, ezInt32 iCount = 1);
...
/// A class that sets a custom ezTestLogInterface as the thread local default log system,
