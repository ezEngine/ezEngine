...
void ezQtEditorApp::SetStyleSheet()
{
  ...
  palette.setColor(QPalette::Button, QColor(68, 69, 68, 255));
  palette.setColor(QPalette::Light, QColor(62, 62, 62, 255));
  palette.setColor(QPalette::Midlight, QColor(58, 58, 58, 255));
  palette.setColor(QPalette::Dark, QColor(40, 40, 40, 255));
  palette.setColor(QPalette::Mid, QColor(54, 54, 54, 255));
  palette.setColor(QPalette::Text, QColor(221, 221, 221, 255));
  palette.setColor(QPalette::BrightText, QColor(221, 221, 221, 255));
  palette.setColor(QPalette::ButtonText, QColor(221, 221, 221, 255));
  palette.setColor(QPalette::Base, QColor(52, 52, 52, 255));
  palette.setColor(QPalette::Window, QColor(31, 31, 31, 255));
  palette.setColor(QPalette::Shadow, QColor(0, 0, 0, 255));
  palette.setColor(QPalette::Highlight, ezToQtColor(highlightColor));
  palette.setColor(QPalette::HighlightedText, QColor(52, 52, 52, 255));
  palette.setColor(QPalette::Link, ezToQtColor(linkColor));
  palette.setColor(QPalette::LinkVisited, ezToQtColor(linkVisitedColor));
  palette.setColor(QPalette::AlternateBase, QColor(52, 52, 52, 255));
  QBrush NoRoleBrush(QColor(0, 0, 0, 255), Qt::NoBrush);
  palette.setBrush(QPalette::NoRole, NoRoleBrush);
  palette.setColor(QPalette::ToolTipBase, QColor(52, 52, 52, 255));
  palette.setColor(QPalette::ToolTipText, QColor(221, 221, 221, 255));
  ...
  palette.setColor(QPalette::Disabled, QPalette::Button, QColor(68, 69, 68, 255));
