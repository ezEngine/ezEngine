...
ezVisualizerAdapter::~ezVisualizerAdapter()
{
  ...
  if (m_pObject)
  {
    ...
    m_pObject->GetDocumentObjectManager()->GetDocument()->GetHostDocument()->m_DocumentObjectMetaData.m_DataModifiedEvent.RemoveEventHandler(ezMakeDelegate(&ezVisualizerAdapter::DocumentObjectMetaDataEventHandler, this));
  }
}
