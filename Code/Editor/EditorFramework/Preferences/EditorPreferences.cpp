...
EZ_BEGIN_DYNAMIC_REFLECTED_TYPE(ezEditorPreferencesUser, 1, ezRTTIDefaultAllocator<ezEditorPreferencesUser>)
{
  EZ_BEGIN_PROPERTIES
  {
    ...
    EZ_MEMBER_PROPERTY("SkyBox", m_bSkyBox)->AddAttributes(new ezGroupAttribute("Engine View Light Settings")),
    ...
    EZ_MEMBER_PROPERTY("DirectionalLightAngle", m_DirectionalLightAngle)->AddAttributes(new ezDefaultValueAttribute(ezAngle::Degree(60.0f)), new ezClampValueAttribute(ezAngle::Degree(-90.0f), ezAngle::Degree(90.0f))),
