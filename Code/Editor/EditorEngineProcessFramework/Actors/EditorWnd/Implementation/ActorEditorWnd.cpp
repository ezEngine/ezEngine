...
ezActorEditorWnd::ezActorEditorWnd(const char* szActorName, const char* szGroupName, ezUniquePtr<ezEditorProcessViewWindow>&& pWindow)
...
void ezActorEditorWnd::Activate()
{
  ...
  AddDevice(EZ_DEFAULT_NEW(ezActorDeviceRenderOutputEditorWnd, m_OutputTarget.Borrow()));
}
