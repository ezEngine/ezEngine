...
ezApplication::ApplicationExecution ezComputeShaderHistogramApp::Run()
{
  ...
  // do the rendering
  {
    ...
    // Compute histogram.
    {
      ...
      renderContext.Dispatch(g_uiWindowWidth / g_uiComputeThreadGroupSize + (g_uiWindowWidth % g_uiComputeThreadGroupSize != 0 ? 1 : 0), g_uiWindowHeight / g_uiComputeThreadGroupSize + (g_uiWindowHeight % g_uiComputeThreadGroupSize != 0 ? 1 : 0));
