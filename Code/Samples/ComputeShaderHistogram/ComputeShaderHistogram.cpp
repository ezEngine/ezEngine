...
#include "../../../Data/Samples/ComputeShaderHistogram/Shaders/clearParams.h"
...
void ezComputeShaderHistogramApp::Run()
{
  ...
  // do the rendering
  {
    ...
    // Render screen texture to backbuffer
    {
      ...
      renderContext.BindShader(m_hScreenCopyShader);
    ...
    // Compute histogram.
    {
      ...
      ezBindGroupBuilder& bindGroup = ezRenderContext::GetDefaultInstance()->GetBindGroup();
      // Reset first.
      renderContext.BindShader(m_hHistogramClearShader);
      ClearParams params;
      params.Height = 3;
      params.Width = 256;
      renderContext.SetPushConstants("ClearParams", params);
...
void ezComputeShaderHistogramApp::AfterCoreSystemsStartup()
{
  ...
  // Setup Shaders and Materials
  {
    ...
    m_hScreenCopyShader = ezResourceManager::LoadResource<ezShaderResource>("Shaders/screenCopy.ezShader");
    m_hHistogramComputeShader = ezResourceManager::LoadResource<ezShaderResource>("Shaders/histogramcompute.ezShader");
    m_hHistogramClearShader = ezResourceManager::LoadResource<ezShaderResource>("Shaders/histogramclear.ezShader");
...
void ezComputeShaderHistogramApp::BeforeHighLevelSystemsShutdown()
{
  ...
  m_hScreenCopyShader.Invalidate();
