...
function(ez_set_target_output_dirs TARGET_NAME LIB_OUTPUT_DIR DLL_OUTPUT_DIR)
	...
	elseif ("${CMAKE_BUILD_TYPE}" STREQUAL ${EZ_BUILDTYPENAME_DEV})
        set_target_properties(${TARGET_NAME} PROPERTIES
			...
			LIBRARY_OUTPUT_DIRECTORY "${OUTPUT_LIB_DEV}"
    ...
    set_target_properties(${TARGET_NAME} PROPERTIES
        ...
        LIBRARY_OUTPUT_DIRECTORY_${EZ_BUILDTYPENAME_DEBUG_UPPER} "${OUTPUT_LIB_DEBUG}"
    ...
    set_target_properties(${TARGET_NAME} PROPERTIES
      ...
      LIBRARY_OUTPUT_DIRECTORY_${EZ_BUILDTYPENAME_RELEASE_UPPER} "${OUTPUT_LIB_RELEASE}"
    ...
    set_target_properties(${TARGET_NAME} PROPERTIES
        ...
        LIBRARY_OUTPUT_DIRECTORY_${EZ_BUILDTYPENAME_DEV_UPPER} "${OUTPUT_LIB_DEV}"
