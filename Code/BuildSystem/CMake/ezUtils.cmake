...
function(ez_set_common_target_definitions TARGET_NAME)
	...
	target_compile_definitions(${TARGET_NAME} PRIVATE BUILDSYSTEM_VERSION_MAJOR="${EZ_CMAKE_VERSION_MAJOR}")
	target_compile_definitions(${TARGET_NAME} PRIVATE BUILDSYSTEM_VERSION_MINOR="${EZ_CMAKE_VERSION_MINOR}")
	target_compile_definitions(${TARGET_NAME} PRIVATE BUILDSYSTEM_VERSION_PATCH="${EZ_CMAKE_VERSION_PATCH}")
