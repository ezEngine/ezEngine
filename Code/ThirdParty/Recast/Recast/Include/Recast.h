...
/// @see rcContext
class RECAST_API rcScopedTimer
{
public:
...
/// @ingroup recast
struct RECAST_API rcHeightfield
{
	rcHeightfield();
	~rcHeightfield();
...
RECAST_API void rcCalcBounds(const float* verts, int numVerts, float* minBounds, float* maxBounds);
...
RECAST_API void rcCalcGridSize(const float* minBounds, const float* maxBounds, float cellSize, int* sizeX, int* sizeZ);
...
RECAST_API bool rcCreateHeightfield(rcContext* context, rcHeightfield& heightfield, int sizeX, int sizeZ,
...
RECAST_API void rcMarkWalkableTriangles(rcContext* context, float walkableSlopeAngle, const float* verts, int numVerts,
...
/// @param[in]		numTris				The number of triangles.
/// @param[out]		triAreaIDs			The triangle area ids. [Length: >= @p nt]
RECAST_API void rcClearUnwalkableTriangles(rcContext* context, float walkableSlopeAngle, const float* verts, int numVerts,
								const int* tris, int numTris, unsigned char* triAreaIDs); 
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcAddSpan(rcContext* context, rcHeightfield& heightfield,
	           int x, int z,
...
/// 									[Limit: >= 0] [Units: vx]
/// @returns True if the operation completed successfully.
RECAST_API bool rcRasterizeTriangle(rcContext* context,
...
///										[Limit: >= 0] [Units: vx]
/// @returns True if the operation completed successfully.
RECAST_API bool rcRasterizeTriangles(rcContext* context,
...
RECAST_API void rcFilterLowHangingWalkableObstacles(rcContext* context, int walkableClimb, rcHeightfield& heightfield);
...
/// 								[Limit: >=0] [Units: vx]
/// @param[in,out]	heightfield			A fully built heightfield.  (All spans have been added.)
RECAST_API void rcFilterLedgeSpans(rcContext* context, int walkableHeight, int walkableClimb, rcHeightfield& heightfield);
...
/// 								be considered walkable. [Limit: >= 3] [Units: vx]
/// @param[in,out]	heightfield		A fully built heightfield.  (All spans have been added.)
RECAST_API void rcFilterWalkableLowHeightSpans(rcContext* context, int walkableHeight, rcHeightfield& heightfield);
...
RECAST_API int rcGetHeightFieldSpanCount(rcContext* context, const rcHeightfield& heightfield);
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildCompactHeightfield(rcContext* context, int walkableHeight, int walkableClimb,
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcErodeWalkableArea(rcContext* context, int erosionRadius, rcCompactHeightfield& compactHeightfield);
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcMedianFilterWalkableArea(rcContext* context, rcCompactHeightfield& compactHeightfield);
...
/// @param[in,out]	compactHeightfield	A populated compact heightfield.
RECAST_API void rcMarkBoxArea(rcContext* context, const float* boxMinBounds, const float* boxMaxBounds, unsigned char areaId,
...
/// @param[in]		areaId				The area id to apply. [Limit: <= #RC_WALKABLE_AREA]
/// @param[in,out]	compactHeightfield	A populated compact heightfield.
RECAST_API void rcMarkConvexPolyArea(rcContext* context, const float* verts, int numVerts,
...
RECAST_API int rcOffsetPoly(const float* verts, int numVerts, float offset, float* outVerts, int maxOutVerts);
...
/// @param[in]		areaId				The area id to apply. [Limit: <= #RC_WALKABLE_AREA]
/// @param[in,out]	compactHeightfield	A populated compact heightfield.
RECAST_API void rcMarkCylinderArea(rcContext* context, const float* position, float radius, float height,
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildDistanceField(rcContext* ctx, rcCompactHeightfield& chf);
...
/// 								be merged with larger regions. [Limit: >=0] [Units: vx] 
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildRegions(rcContext* ctx, rcCompactHeightfield& chf, int borderSize, int minRegionArea, int mergeRegionArea);
...
///  								[Limit: >=0] [Units: vx].
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildLayerRegions(rcContext* ctx, rcCompactHeightfield& chf, int borderSize, int minRegionArea);
...
///  								be merged with larger regions. [Limit: >=0] [Units: vx] 
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildRegionsMonotone(rcContext* ctx, rcCompactHeightfield& chf,
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildHeightfieldLayers(rcContext* ctx, const rcCompactHeightfield& chf, 
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildContours(rcContext* ctx, const rcCompactHeightfield& chf,
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildPolyMesh(rcContext* ctx, const rcContourSet& cset, const int nvp, rcPolyMesh& mesh);
...
///  @returns True if the operation completed successfully.
RECAST_API bool rcMergePolyMeshes(rcContext* ctx, rcPolyMesh** meshes, const int nmeshes, rcPolyMesh& mesh);
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcBuildPolyMeshDetail(rcContext* ctx, const rcPolyMesh& mesh, const rcCompactHeightfield& chf,
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcCopyPolyMesh(rcContext* ctx, const rcPolyMesh& src, rcPolyMesh& dst);
...
/// @returns True if the operation completed successfully.
RECAST_API bool rcMergePolyMeshDetails(rcContext* ctx, rcPolyMeshDetail** meshes, const int nmeshes, rcPolyMeshDetail& mesh);
