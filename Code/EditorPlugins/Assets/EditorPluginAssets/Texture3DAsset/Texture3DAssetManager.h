...
class ezTexture3DAssetDocumentManager : public ezAssetDocumentManager
{
  EZ_ADD_DYNAMIC_REFLECTION(ezTexture3DAssetDocumentManager, ezAssetDocumentManager);

public:
  ezTexture3DAssetDocumentManager();
  ~ezTexture3DAssetDocumentManager();
