...
{
  int screenX = clamp(screenPosition.x, 0, ViewportSize.x - 1);
  int screenY = clamp(screenPosition.y, 0, ViewportSize.x - 1);

  float depthFromZBuffer = SceneDepth.Load(int4(screenX, screenY, s_ActiveCameraEyeIndex, 0)).r;
