...
#define	EDITOR_RENDER_PASS_EMISSIVE_COLOR 7
#define	EDITOR_RENDER_PASS_ROUGHNESS 8
#define	EDITOR_RENDER_PASS_OCCLUSION 9
#define	EDITOR_RENDER_PASS_DEPTH 10
