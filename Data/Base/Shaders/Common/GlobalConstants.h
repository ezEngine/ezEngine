...
#define	EDITOR_RENDER_PASS_TANGENTS 4
#define	EDITOR_RENDER_PASS_DIFFUSE_COLOR 5
#define	EDITOR_RENDER_PASS_DIFFUSE_COLOR_RANGE 6
#define	EDITOR_RENDER_PASS_SPECULAR_COLOR 7
#define	EDITOR_RENDER_PASS_EMISSIVE_COLOR 8
#define	EDITOR_RENDER_PASS_ROUGHNESS 9
#define	EDITOR_RENDER_PASS_OCCLUSION 10
#define	EDITOR_RENDER_PASS_DEPTH 11
