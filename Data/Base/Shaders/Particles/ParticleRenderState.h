BlendingEnabled0 = true SourceBlend0 = Blend_SrcAlpha
  DepthTest = true DepthTestFunc = CompareFunc_LessEqual
    DepthWrite = false CullMode = CullMode_None
      ...
      BlendingEnabled0 = false DepthWrite = true
