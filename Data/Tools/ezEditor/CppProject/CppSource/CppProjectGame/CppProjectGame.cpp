...
EZ_APPLICATION_ENTRY_POINT(CppProjectGame);

CppProjectGame::CppProjectGame()
  : ezGameApplication("CppProject", nullptr)
{
}

ezResult CppProjectGame::TryProjectFolder(ezStringView sPath)
{
...
ezUniquePtr<ezGameStateBase> CppProjectGame::CreateGameState()
{
...
ezResult CppProjectGame::BeforeCoreSystemsStartup()
{
...
void CppProjectGame::Run_InputUpdate()
{
