...
{\n\
  ...
  {
    StreamComparer sc("\"var1\" : { \"$t\" : \"vec2\", \"$v\" : \"(1.00000000, 2.00000000)\", \"$b\" : \"0x0000803F00000040\" }");
  ...
  {
    StreamComparer sc("\"var1\" : { \"$t\" : \"vec3\", \"$v\" : \"(1.00000000, 2.00000000, 3.00000000)\", \"$b\" : \"0x0000803F0000004000004040\" }");
  ...
  {
    StreamComparer sc("\"var1\" : { \"$t\" : \"vec4\", \"$v\" : \"(1.00000000, 2.00000000, 3.00000000, 4.00000000)\", \"$b\" : \"0x0000803F000000400000404000008040\" }");
  ...
  {
    StreamComparer sc("\"var1\" : { \"$t\" : \"quat\", \"$v\" : \"(1.00000000, 2.00000000, 3.00000000, 4.00000000)\", \"$b\" : \"0x0000803F000000400000404000008040\" }");
...
\"var2\" : { \"$t\" : \"uint64\", \"$v\" : \"42\", \"$b\" : \"0x2A00000000000000\" }");
  ...
  {
    StreamComparer sc("\
\"var1\" : { \"$t\" : \"float\", \"$v\" : \"-65.50000000\", \"$b\" : \"0x000083C2\" },\n\
\"var2\" : { \"$t\" : \"float\", \"$v\" : \"2621.25000000\", \"$b\" : \"0x00D42345\" }");
...
\"var2\" : { \"$t\" : \"double\", \"$v\" : \"2621.06250000\", \"$b\" : \"0x00000000207AA440\" }");
  ...
  {
    StreamComparer sc("\
\"var1\" : { \"$t\" : \"time\", \"$v\" : \"0.50000000\", \"$b\" : \"0x000000000000E03F\" },\n\
\"var2\" : { \"$t\" : \"time\", \"$v\" : \"2.25000000\", \"$b\" : \"0x0000000000000240\" }");
  ...
  EZ_TEST_BLOCK(ezTestBlock::Enabled, "AddVariableVariant")
  {
    StreamComparer sc("\
\"var1\" : { \"$t\" : \"int32\", \"$v\" : \"23\", \"$b\" : \"0x17000000\" },\n\
\"var2\" : { \"$t\" : \"float\", \"$v\" : \"42.50000000\", \"$b\" : \"0x00002A42\" },\n\
...
{\n\
  ...
  \"float\" : { \"$t\" : \"float\", \"$v\" : \"64.72000122\", \"$b\" : \"0xA4708142\" },\n\
  \"bool\" : true,\n\
  \"int\" : { \"$t\" : \"int32\", \"$v\" : \"23\", \"$b\" : \"0x17000000\" },\n\
  \"myarray\" : [ { \"$t\" : \"int32\", \"$v\" : \"1\", \"$b\" : \"0x01000000\" }, { \"$t\" : \"float\", \"$v\" : \"2.20000005\", \"$b\" : \"0xCDCC0C40\" }, { \"$t\" : \"double\", \"$v\" : \"3.30000000\", \"$b\" : \"0x6666666666660A40\" }, false, \"ende\" ],\n\
  \"object\" : \n\
  {\n\
    \"variable in object\" : \"bla\",\n\
    \"Subobject\" : \n\
