...
{
public:
  ezRawPropertyWidget(QWidget* pParent, const ezHybridArray<ezPropertyEditorBaseWidget::Selection, 8>& items);
...
private:
  void BuildUI(const ezHybridArray<ezPropertyEditorBaseWidget::Selection, 8>& items, const ezRTTI* pType, ezPropertyPath& ParentPath, QLayout* pLayout);
