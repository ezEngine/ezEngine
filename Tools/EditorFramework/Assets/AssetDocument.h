...
public:
  ...
  ezStatus TransformAsset(bool bTriggeredManually, const ezAssetPlatformConfig* pPlatformConfig = nullptr);
...
protected:
  ...
  virtual ezStatus InternalTransformAsset(ezStreamWriter& stream, const char* szOutputTag, const ezAssetPlatformConfig* pPlatformConfig, const ezAssetFileHeader& AssetHeader, bool bTriggeredManually) = 0;
  ...
  virtual ezStatus InternalTransformAsset(const char* szTargetFile, const char* szOutputTag, const ezAssetPlatformConfig* pPlatformConfig, const ezAssetFileHeader& AssetHeader, bool bTriggeredManually);
...
private:
  ...
  ezStatus DoTransformAsset(const ezAssetPlatformConfig* pPlatformConfig, bool bTriggeredManually);
