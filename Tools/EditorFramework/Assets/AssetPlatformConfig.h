...
///
///
class ezAssetTypePlatformConfig : public ezReflectedClass
{
...
class ezTextureAssetTypePlatformConfig : public ezAssetTypePlatformConfig
{
...
class ezAssetPlatformConfig : public ezReflectedClass
{
