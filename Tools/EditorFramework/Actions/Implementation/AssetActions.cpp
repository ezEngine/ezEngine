...
void ezAssetActions::RegisterActions()
{
  ...
  s_hTransformAsset = EZ_REGISTER_ACTION_1("TransformAsset", "Transform Asset", ezActionScope::Global, "Assets", "", ezAssetAction, ezAssetAction::ButtonType::TransformAsset);
  ...
  s_hRetrieveAssetInfo = EZ_REGISTER_ACTION_1("RetrieveAssetInfo", "Retrieve Asset Info", ezActionScope::Global, "Assets", "", ezAssetAction, ezAssetAction::ButtonType::RetrieveAssetInfo);
}
