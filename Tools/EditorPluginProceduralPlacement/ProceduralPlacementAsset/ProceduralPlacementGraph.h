...
{
  EZ_DECLARE_SINGLETON(ezProceduralPlacementNodeRegistry);

public:
  ezProceduralPlacementNodeRegistry();
...
class ezProceduralPlacementNodeManager : public ezDocumentNodeManager
{
public:
