...
EZ_BEGIN_DYNAMIC_REFLECTED_TYPE(ezProceduralPlacementComponentDragDropHandler, 1, ezRTTIDefaultAllocator<ezProceduralPlacementComponentDragDropHandler>)
...
void ezProceduralPlacementComponentDragDropHandler::OnDragBegin(const ezDragDropInfo* pInfo)
{
  ...
  if (pInfo->m_sTargetContext == "viewport")
    ...
    CreateDropObject(pInfo->m_vDropPosition, "ezProceduralPlacementComponent", "Resource", GetAssetGuidString(pInfo), pInfo->m_TargetObject, pInfo->m_iTargetObjectInsertChildIndex);
