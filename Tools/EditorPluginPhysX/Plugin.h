...
// Configure the DLL Import/Export Define
  ...
  #ifdef BUILDSYSTEM_BUILDING_EDITORPLUGINPHYSX
    #define EZ_EDITORPLUGINPHYSX_DLL __declspec(dllexport)
  #else
    #define EZ_EDITORPLUGINPHYSX_DLL __declspec(dllimport)
  #endif
#else
...
EZ_DYNAMIC_PLUGIN_DECLARATION(EZ_EDITORPLUGINPHYSX_DLL, ezEditorPluginPhysX);
