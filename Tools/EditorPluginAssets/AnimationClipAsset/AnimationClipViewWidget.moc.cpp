...
ezQtAnimationClipViewWidget::ezQtAnimationClipViewWidget(QWidget* pParent, ezQtAnimationClipAssetDocumentWindow* pOwnerWindow, ezEngineViewConfig* pViewConfig)
...
ezQtAnimationClipViewWidget::~ezQtAnimationClipViewWidget()
{
}
