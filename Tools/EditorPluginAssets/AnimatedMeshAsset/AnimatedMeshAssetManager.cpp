...
ezResult ezAnimatedMeshAssetDocumentManager::OpenPickedDocument(const ezDocumentObject* pPickedComponent, ezUInt32 uiPartIndex)
{
  ...
  ezAnimatedMeshAssetDocument* pMeshDoc = static_cast<ezAnimatedMeshAssetDocument*>(
