...
namespace ezModelImporter
{
  ...
  inline void VertexDataStream::SetDataIndex(VertexIndex vertex, VertexDataIndex data)
  {
    ...
    EZ_ASSERT_DEBUG(data.m_Value % m_uiNumElementsPerVertex == 0, "Vertex data index value must be a mulitple of the element count per vertex (%i with this instance).", m_uiNumElementsPerVertex);
  ...
  {
    EZ_ASSERT_DEBUG(values.GetCount() % m_uiNumElementsPerVertex == 0, "Number of added values needs to be a multiple of %i", m_uiNumElementsPerVertex);
