...
#define STATIC_VEC_CHECK(ELEM_COUNT, TYPE, TYPENAME) \
    ...
    { \
      EZ_ASSERT_DEV(sourceDataStream.GetElementType() == VertexDataStream::ElementType::TYPENAME && \
    ...
    {
      EZ_ASSERT_DEV(sourceDataStream.GetElementType() == VertexDataStream::ElementType::FLOAT &&
    ...
    {
      EZ_ASSERT_DEV(sourceDataStream.GetElementType() == VertexDataStream::ElementType::INT32 &&
    ...
    {
      EZ_ASSERT_DEV(sourceDataStream.GetElementType() == VertexDataStream::ElementType::UINT32 &&
