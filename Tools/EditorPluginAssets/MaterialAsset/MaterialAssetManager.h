...
public:
  ...
  virtual ezString GetRelativeOutputFileName(const char* szDataDirectory, const char* szDocumentPath, const char* szOutputTag, const ezAssetPlatformConfig* pPlatformConfig) const override;
