...
void ezSceneActions::RegisterActions()
{
  ...
  s_hRenderShapeIcons = EZ_REGISTER_ACTION_1("Scene.Render.ShapeIcons", ezActionScope::Document, "Scene", "Enter", ezSceneAction, ezSceneAction::ActionType::RenderShapeIcons);
