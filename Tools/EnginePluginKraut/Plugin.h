...
// Configure the DLL Import/Export Define
    ...
    #define EZ_ENGINEPLUGINKRAUT_DLL __declspec(dllexport)
  #else
#    define EZ_ENGINEPLUGINKRAUT_DLL __declspec(dllimport)
  #endif
#else
...
EZ_DYNAMIC_PLUGIN_DECLARATION(EZ_ENGINEPLUGINKRAUT_DLL, ezEnginePluginKraut);
